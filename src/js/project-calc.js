...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const typeOfWarmFloor = document.querySelectorAll(
    '*[data-group="typeof-warm-floor"]'
  );
  ...
  tab(
    "#typeof-walls-control .project-calc__tab-nav .project-calc__label",
  ...
  tab(
    "#typeof-floor-control .project-calc__tab-nav .project-calc__label",
