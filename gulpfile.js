...
const path = {
  ...
  images: {
    // svg: './src/img/**/*.svg',
    source: ['./src/img/**/*.jpg', './src/img/**/*.jpeg', './src/img/**/*.png', './src/img/**/*.svg'],
    result: './app/img'
  },
  fonts: {
    allFons: './src/fonts/**',
  ...
  scripts: {
    libs: [
      ...
      './src/libs/jquery.cookie/jquery.cookie.js',
...
const watchFiles = () => {
  ...
  config.isPug ? watch(path.html.pug, pugCompiller) : watch(path.html.html, html);
...
exports.default = series(
  clean,
  parallel(config.isPug ? pugCompiller : html, scriptLibs, scripts, fonts, image, resources),
  syleLibs,
  styles,
  watchFiles
);
...
exports.build = series(
  clean,
  parallel(config.isPug ? pugCompiller : html, scriptLibs, scriptsBuild, fonts, imageBuild, resources),
  syleLibs,
  stylesBuild,
  destination
);
